...
step << !Undead !Rogue
    ...
    >>杀死半人马入侵者，和部落保卫者一起会提高你的效率，掠夺他们的护腕。
    .complete 855,1 --Centaur Bracers (15)
step
	>>杀死科多班恩。一直杀半人马可以获得科卡尔宝箱钥匙，科多班恩干掉他，抢他的头。
...
step
	#label Samophlange
    >>单击控制台，机器就在旁边，机关不明显，都是阀门仔细看下，点了会招小弟
...
step
	...
	#hardcore
    #completewith next
    +接下来的3个任务可能很难，要格外小心，打火石任务在机器人那接。

step
    >>杀死鲁格维兹主管(他在水里塔上的操作室)。抢他取点火钥匙
...
step
    #label Slugs
    >>当机器人移动到较高的地面上时，会产生2个暴徒。杀死他们，然后等待他的RP事件结束
...
step
    ...
    .complete 821,2 --Plainstrider Kidney (5)
step
    >>在该地区捣乱暴徒。杀死大约25个暴徒，如果翡翠没有掉落，跳过这个任务（爆率感人，看脸）。
...
step << Rogue
    ...
    +跳上船，下楼到二楼，把你的开锁技能练至80
step << Rogue
    .goto The Barrens,64.95,45.44
    >>将E.C.A.C.拖到您的栏上。当你的开锁技能达到80时，去船的底层打开“南海之珠”
...
step << !Undead !Rogue
	#era
    >>在湖边碾磨任何一个半人马，直到它们老大维罗戈出现。刷在小亭子里。
...
step
    .goto The Barrens,44.5,59.2
    .fp Camp Taurajo >>获得陶阿祖营地飞行路线 << !Shaman !Warrior !Tauren
    .fly Crossroads >>飞向十字路口
step
    .goto The Barrens,51.9,30.3
...
step
    >>用枯树上的新鲜斑马尸体召唤Ishamuhale。杀了他，抢了他的牙
...
step
	...
	.goto Ashenvale,42.3,71.0,20    >>前往石爪小径。穿过洞穴跑到灰谷
step
	#completewith next
	.goto Ashenvale,16.3,29.8,90 >>前往佐拉姆加前哨。途中一定要避开阿斯特拉纳卫队
step
     #completewith next
    .goto Ashenvale,12.20,33.80
    .fp Zoram'gar Outpost >>获取佐拉姆加前哨飞行路线
step
	#sticky
	#label VorshaL
