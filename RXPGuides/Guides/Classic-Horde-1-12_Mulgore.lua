...
step << !Shaman
    #requires Belt
    >>到洞里去（洞口在63.1，81.9）。拿走走洞里地面上的地图，然后右键单击它，触发任务。
...
step
    .xp 5+2395>>做任务给的装备替换下，兜里比身上好的替换一下，石化武器是武器附魔，石肤图腾是释放的范围增益，刷随机路上遇到的野怪提升经验到2395+/2800xp
]])
...
step
	#completewith next
	#softcore
    .goto Mulgore,46.5,55.5,300 >>死去并在精神治疗者处重生，或者跑到血蹄村
step
	#hardcore
	#completewith next
...
step << Shaman/Druid
    .goto Mulgore,45.7,58.6
      .vendor >>供应商处卖垃圾。如果你有足够的钱买手杖(5s4c)，就卖掉你的武器。如果不够，请跳过此步骤
    .collect 2495,1 --Collect Walking Stick
step << Warrior
    .goto Mulgore,45.7,58.6
        .vendor >>供应商处卖垃圾。如果能给你足够的钱买木槌(7s1c)，就卖掉你的武器。如果不够，请跳过此步骤
...
step << Hunter
    ...
    .vendor >>供应商处卖垃圾。如果你的武器能给你足够的钱来对付Ornate Blunderbus(4s 14c)，就把它卖掉。如果不够，请跳过此步骤
...
step
    #sticky
    #completewith Well
    >>在整个区域寻找时，为|cRXP_FRIENDLY_Kawnie|r 获取物品
...
step << Tauren
    ...
    >>为爪子杀狼，为鸟的爪子杀平原陆行鸟。杀死一只平原陆行鸟以获得鲜嫩的漫游者肉
...
step
    ...
    >>在两个营地之间来回移动，杀死豺狼人。注意断矛(9级稀有怪)。他太难杀了。
...
step << Shaman/Druid
    .goto Mulgore,45.7,58.6
     >>供应商处卖垃圾。如果你有足够的钱买手杖(5s4c)，就卖掉你的武器。如果不够，请跳过此步骤
    .collect 2495,1 --Collect Walking Stick
step << Warrior
    .goto Mulgore,45.7,58.6
    .money <0.0701
...
step << Hunter
    ...
    .trainer >>如果你还需要训练你的职业技能
step
    >>寻找|cRXP_FRIENDLY_摩林·云行者|r  。他沿着东路巡逻
...
step
    #completewith Clawsx
    >>在整个区域寻找时，为|cRXP_FRIENDLY_茂尔·祈雨|r  获取物品
    .complete 766,1 --Prairie Wolf Heart (1)
    .complete 766,2 --Flatland Cougar Femur (1)
    .complete 766,3 --Plainstrider Scale (1)
    .complete 766,4 --Swoop Gizzard (1)
...
step << Warrior
    ...
    .vendor >>供应商处卖垃圾。买尽可能多的新鲜烘焙面包
step << Druid/Shaman
    .goto Mulgore,46.7,60.7
    .vendor >>供应商处卖垃圾。买尽可能多的冰镇牛奶
step << Tauren
	#era/som
...
step
    #completewith Burial
    >>完成为|cRXP_FRIENDLY_茂尔·祈雨|r  获取物品
    .complete 766,1 --Prairie Wolf Heart (1)
    .complete 766,2 --Flatland Cougar Femur (1)
    .complete 766,3 --Plainstrider Scale (1)
    .complete 766,4 --Swoop Gizzard (1)
...
step << Warrior/Shaman
    #sticky
    #completewith next
    +杀死Plainstriders以获得10c+的供应商处卖垃圾
    .goto Mulgore,45.6,74.0,30,0
step << Warrior/Shaman
    .goto Mulgore,45.3,76.5
    .vendor >>供应商处卖垃圾
...
step
	#completewith Burial
    >>在整个区域寻找时，为|cRXP_FRIENDLY_茂尔·祈雨|r  获取物品。狼换心脏，美洲狮换股骨，平原陆行鸟换鳞片，暴雪换Swoops
    .complete 766,1 --Prairie Wolf Heart (1)
    .complete 766,2 --Flatland Cougar Femur (1)
    .complete 766,3 --Plainstrider Scale (1)
    .complete 766,4 --Swoop Gizzard (1)
