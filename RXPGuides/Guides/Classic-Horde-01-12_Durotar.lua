...
step << Hunter
    .goto Durotar,42.6,67.3
    .vendor >>供应商处卖垃圾。购买箭，直到你的箭袋装满为止(1000支箭)
step
    #era
...
step
    #sticky
    #label Peons
   .use 16114 >>用工头的木棒叫醒树旁熟睡的懒惰的苦工(把它放在你的快捷键上，让它更容易使用)
...
step
   ...
   .use 16114 >>把树周围的苦工叫醒。如果你很难找到睡觉的苦工，就多绕一圈。
    .complete 5441,1 --Peons Awoken (5)
step << !Warlock
	#som
	#phase 3-6
...
step << Shaman
    ...
    >>修理你的武器。如果你有足够的钱(5s4c)，请从特莱耶克购买一根手杖。否则，请跳过此步骤(稍后再回来)
    .collect 2495,1 --Collect Walking Stick
step << Rogue
    .goto Durotar,56.5,73.1
     >>修理你的武器。如果你有足够的钱(4s1c)，请从特莱耶克购买细高跟鞋。否则，请跳过此步骤(稍后再回来)
    .collect 2494,1 --Collect Stiletto
step << Orc Warrior
    .goto Durotar,56.5,73.1
    >>修理你的武器。如果你有足够的钱(4s84c)，请从特莱耶克购买一把大斧头。否则，请跳过此步骤(稍后再回来)
    .collect 2491,1 --Collect Large Axe
step << Troll Warrior
    .goto Durotar,56.5,73.1
    >>修理你的武器。如果你有足够的钱(5s40c)，就从特莱耶克买一辆Tomahawk。否则，请跳过此步骤(稍后再回来)
    .collect 2490,1 --Collect Tomahawk
step << Hunter
    .goto Durotar,56.5,73.1
    >>修理你的武器。如果你有足够的钱(2秒85美分)，请从特莱耶克购买Hornwood Recurrive Bow。否则，请跳过此步骤(稍后再回来)
...
step
    ...
    >>沿着海滩奔跑，尽可能多地杀死小海浪蟹和厚壳龙虾人，以获取蟹胶和龙虾人的眼睛。您不必在此处完成此步骤。
...
step << Rogue
    ...
    #softcore
    .goto Durotar,56.5,73.1
     >>修理你的武器。如果你有足够的钱(4s1c)，请从特莱耶克购买卷刃的剑。否则，请跳过此步骤(稍后再回来)
	>>你可以从外面和他说话
    .collect 2494,1 --Collect Stiletto
step << Orc Warrior
	#era/som
    #softcore
    .goto Durotar,56.5,73.1
    >>修理你的武器。如果你有足够的钱(4s84c)，请从特莱耶克购买一把双刃战斧。否则，请跳过此步骤(稍后再回来)
	>>你可以从外面和他说话
    .collect 2491,1 --Collect Large Axe
step << Troll Warrior
	#era/som
    #softcore
    .goto Durotar,56.5,73.1
    >>修理你的武器。如果你有足够的钱(5s40c)，就从特莱耶克买一把小手斧。否则，请跳过此步骤(稍后再回来)
	>>你可以从外面和他说话
    .collect 2490,1 --Collect Tomahawk
step << Hunter
	#era/som
    #softcore
    .goto Durotar,56.5,73.1
    >>修理你的武器。如果你有足够的钱(2银85铜)，请从特莱耶克购买角木弯弓。否则，请跳过此步骤(稍后再回来)
	>>你可以从外面和他说话
    .collect 2506,1 --Collect Hornwood Recurve Bow
step
    #softcore
...
step
    ...
    #hardcore
    #completewith next
    .goto Durotar,52.2,43.2,120 >>前往剃刀岭
step
...
step << Hunter
    .goto Durotar,53.0,41.0
    .vendor >>从特莱耶克那里买足够的箭来装满你的箭袋
step << Warrior/Rogue
    .goto Durotar,52.0,40.7
    .money <0.0020
    .train 2018 >>学习铁匠。锻造允许你制造锐化宝石(+2武器伤害，持续1小时)。如果你愿意，可以跳过锻造和采矿
step << Warrior/Rogue
...
step
    ...
    >>去要塞的顶层。杀死本尼迪克中尉并抢走他的钥匙-小心他使用盾牌猛击(打断)，打死摸尸体拿到钥匙去隔壁阳台开箱子，有触发任务。
    .complete 784,3 --Lieutenant Benedict (1)
    .collect 4882,1 --Collect Benedict's Key (1)
step
    .goto Durotar,59.8,57.8,12,0
    .goto Durotar,59.9,57.5,12 >>在这里上楼梯去隔壁阳台开箱子，点道具触发任务。
    >>掠夺箱子。点击物品接受触发任务
...
step
    #sticky
    #completewith Tools
    >>在这里杀死小海浪蟹和厚壳龙虾人，以获取蟹胶和龙虾人的眼睛
    .complete 818,1 --Intact Makrura Eye (4)
    .complete 818,2 --Crawler Mucus (8)
step
    #label Tools
    >>检查离海岸最近的船上的工具箱。如果找不到这些小桶，请查看其他船只。它们可能有点难找
    .goto Durotar,61.9,55.5,12 >>在水下的破船里（别淹死）
...
step
    #sticky
    #completewith Fur
    >>杀死所有你看到的老虎的拾取皮毛。现在不需要直接完成遇到就杀。
    .complete 817,1 --Durotar Tiger Fur (4)
step
    >>游到岛上。在这个岛上的地上掠夺尾鞭龙的蛋。他们通常由尾鞭龙看守
    .goto Durotar,68.8,71.5
    .complete 815,1 --Taillasher Egg (3)
step
    #sticky
    #completewith next
    >>在这里杀死小海浪蟹和厚壳龙虾人，以获取蟹胶和龙虾人的眼睛。现在不需要急于完成遇到就打。
    .complete 818,1 --Intact Makrura Eye (4)
    .complete 818,2 --Crawler Mucus (8)
step
...
step
    ...
    >>杀死扎拉扎内。当他施放治愈之波时，保存你的拳击。掠夺他的头 << Shaman
...
step
    #softcore
    .goto Durotar,57.5,73.3,200 >>在精神治疗者处死亡并重生，或者腿着
step
    >>杀死小海浪蟹和厚壳龙虾人，以获取蟹胶和龙虾人的眼睛
...
step
    ...
    .vendor >>武器商人处卖垃圾处理和维修。你可以在小屋外面和他说话
step << Mage
    >>到帐篷里去
...
step << Hunter
	...
	#phase 3-6
    .goto Durotar,53.0,41.0
    .vendor >>供应商处卖垃圾箱。购买10级箭，直到你的箭袋装满为止(1000支箭)
step
...
step
    .goto Durotar,43.8,39.1
    >>杀死该地区的传令兵和卫兵。传令兵施放回春(治疗)，而卫兵则是坦克。
...
step << Hunter
	#era/som
    .goto Durotar,53.0,41.0
    .vendor >>供应商处卖垃圾箱。购买10级箭，直到你的箭袋满为止(1000支箭)
step
...
step
    #completewith next
    .goto Durotar,41.7,25.5,120 >>跳进雷霆山
step
	#softcore
    .use 4945 >>杀死费索，并为他的爪子掠夺他。尽量清除周围营地的暴徒，腾出空间。很多时候，先杀死他的宠物是有道理的。如果需要，使用您的骷髅健康锅。一个很好的开场白是粘胶他，然后走出暗影箭射程，杀死他的宠物而不被他击中。
	>>如果你很吃力，请组队完成此任务
    .goto Durotar,41.9,26.0
    .complete 806,1 --Fizzle's Claw (1)
step
	#hardcore
    .use 4945 >>杀死费索，并为他的爪子掠夺他。尽量清除周围营地的暴徒，腾出空间。在很多时候，先杀死他的宠物是有意义的，如果需要的话，可以使用你的骷髅和健康锅。一个很好的开场白是粘胶他，然后走出暗影箭射程，杀死他的宠物而不被他击中。
    .goto Durotar,41.9,26.0
    .complete 806,1 --Fizzle's Claw (1)
...
step
    ...
    >>在技能栏里放上“野兽训练”。记得稍后教你的宠物技能 << Hunter
step
	#era/som
...
step << Warrior
    .goto Durotar,54.4,42.2
    .vendor >>从供应商购买6格背包，直到你无法装备新背包
step << Hunter
    .goto Durotar,53.0,41.0
    .vendor >>如果你有钱，就买把多层弯弓，补充10级用的箭。
step
...
step << Hunter
    .goto Durotar,55.06,9.91,60 >>跑向骷髅石
step
	#era/som
    #sticky
    #label Collars2
    .goto Durotar,53.08,9.19,0
    >>在骷髅石杀死燃烧之刃暴徒以获得灼热项圈，直到中尉的徽章掉落
...
step
    >>为了燃影之眼杀死加祖兹。他可能在洞穴的多个区域。
    >>在虚空行者身上使用粘胶以避免被击中，使用治疗药剂恢复健康。使用“卡视线”避开加祖兹的暗影箭
    >>杀死加祖兹后，你可以跑到洞穴内发现的水体中躲避虚空行者
    >>他很难杀，所以要小心。如果需要，可以跳过此任务
...
step
	...
	.deathskip >>进入暗影裂口中的怒焰裂谷副本内。死在里面的暴徒中，在精神治疗者那里重生。
step
	#era/som
	#softcore
    >>救命如救火接了，要去找奥格瑞玛暗影裂口的考格汉
...
step << Mage
	#era/som
    +如果您计划通过AoE调平，请手动选择“荒地AoE指南”。否则，选择12-17 贫瘠之地的指南
step << Mage
	#som
	#phase 3-6
    +如果您计划通过AoE调平，请手动选择“荒地AoE指南”。否则，请选择12-17 贫瘠之地的指南请注意，随着最近100%任务xp SoM的变化，Mage AoE研磨比任务路线更糟糕
step << Rogue
    .goto The Barrens,51.5,30.3
    .fly >>飞往奥格瑞玛
step << Rogue
